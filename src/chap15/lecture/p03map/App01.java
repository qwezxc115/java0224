...
public class App01 {
	public static void main(String[] args) {
		...
		map.put("tesla", "car");
		map.put("tesla", "elon musk"); // key 중복 x
		...
		int val3 = map.get("tesla").length();
		String val4 = map.get("bitcoin"); // null return
		...
		Set<String> keys = map.keySet(); // 순서 보장 x
		...
		System.out.println(map.containsValue("boy group"));
	}
}
